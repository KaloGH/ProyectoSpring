...
<%@ include file="../jspf/menuSuperior.jspf" %>
	...
	<thead class="thead-dark">
		...
		<th><a style="color: white;" href="list-alumno?criterio=horas"><spring:message code="etiqueta.horas"/></a></th>
		<th><a style="color: white;" href="list-alumno?criterio=abv"><spring:message code="etiqueta.abreviatura"/></a></th>
	...
	<tr>
		...
		<td>
		<a class="btn btn-danger" href="del-modulo?id=${modulo.getId()}"><spring:message code="boton.borrar"/></a>
		</td>
...
<a class="btn btn-success" href="add-modulo"><spring:message code="boton.anyadir"/></a>
