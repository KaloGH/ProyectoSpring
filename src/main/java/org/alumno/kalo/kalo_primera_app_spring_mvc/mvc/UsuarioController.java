...
public class UsuarioController {
	...
	public ResponseEntity<FileSystemResource> getFile(@PathVariable("nickName") String nickName) {
		...
		/** Implementar l�gica en esta secci�n (y otras...) para rellenar �nombreFicheroConImagen�:
		
		Tener en cuenta que en caso de no estar logeado {loginNickName} ser�
		�Desconocido�, por lo que la imagen a mostrar ser� imagenUsuario/Desconocido.
		Si estamos logeados deberemos de consultar la imagen del usuario que por
		defecto (hasta que el usuario la cambie en un pr�ximo paso)
		deber� ser �Desconocido.jpg�. */
		...
		//El servicio nos devolver� la imagen y nos abstrae de saber donde esta guardada realmente
